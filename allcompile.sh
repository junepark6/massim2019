...
agentfiles=$teamMSdir/agents/*.java
utilityfiles=$teamMSdir/utility/*.java
mainfiles=$teamMSdir/*.java


javac -cp $classpath $agentfiles $utilityfiles $mainfiles -verbose -Xlint:unchecked